...
model Designation {
  ...
  priority     Int
  category     DesignationCategory      @default(ADMINISTRATION)
  directorates DirectorateDesignation[]
}

model DirectorateDesignation {
  directorateId Int
  designationId Int
  ...
  @@id([directorateId, designationId])
}
...
model Directorate {
  ...
  designations     DirectorateDesignation[]
